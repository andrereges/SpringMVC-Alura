...
<footer id="layout-footer">
	<div class="clearfix container">
		<div id="collections-footer">
			<!-- cdc-footer -->
			<p class="footer-title"><s:message code="footer.collection.promotion" /></p>
			...
			<p class="footer-title"><s:message code="footer.otherSubjects" /></p>
			<ul class="footer-text-links">
		...
		<div id="social-footer">
			<!-- books-footer -->
			<p class="footer-title"><s:message code="footer.linksCasaCodigo" /></p>
			<ul class="footer-text-links">
			...
			<p class="footer-title"><s:message code="footer.socialNetworks" /></p>
			<ul>
		...
		<div id="newsletter-footer">
			<!-- social-footer -->
			<p class="footer-title"><s:message code="footer.news" /></p>
				...
				<form
					...
					<ul>
						<li><input type="hidden" name="pageNumber" value="0"/><input
							...
							id="entry_0" placeholder="<s:message code="footer.news.input" />"/></li>
						<li><input type="submit" name="submit"
							value="<s:message code="footer.news.button" />" id="submit-newsletter"/></li>
					</ul>
				</form>
				<ul>
					<li class="ie8"><a
